...
func funcMap() {
	...
	// Это может быть использовано для устранения неоднозначности между отсутствующими ключами
	// и ключами с нулевыми значениями, такими как 0 или “”.
	...
	// Вы можете объявить и наполнить map в одной строке с помощью подобного синтаксиса.
